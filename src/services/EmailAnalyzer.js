    ...
    async getCurrentEmail() {
        ...
        const getDateAsync = () => {
            return new Promise((resolveDate) => {
                ...
                if (window.debugLog) window.debugLog('[VERBOSE] - Compose mode detection details:', {
                ...
                if (isComposeMode) {
                    ...
                    if (window.debugLog) window.debugLog('[VERBOSE] - In compose mode, using null date');
                    resolveDate(null);
                    ...
                    if (window.debugLog) window.debugLog('[VERBOSE] - Using email date for received message:', emailDate);
                    resolveDate(emailDate);
                } else {
                    // For other item types
                    if (window.debugLog) window.debugLog('[VERBOSE] - Other item type, using null date');
                    resolveDate(null);
                }
            });
        };
